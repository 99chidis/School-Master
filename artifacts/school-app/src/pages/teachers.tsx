...
import { Search, Plus, Mail, Phone, BookOpen, CalendarDays, MoreVertical } from 'lucide-react';
...
export default function Teachers() {
  return (
    <AppLayout pageTitle="Teacher Directory">
      <div className="flex flex-col gap-6">
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
          <div className="flex items-center gap-3 w-full sm:w-auto">
            <div className="relative w-full sm:w-72">
              <Search className="absolute left-3 top-1/2 -translate-y-1/2 h-4 w-4 text-slate-400" />
              <Input placeholder="Search teachers..." className="pl-9 h-10 w-full bg-white border-slate-200 shadow-sm" />
            </div>
